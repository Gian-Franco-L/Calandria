...
export default function Calculadoras({ option } : PageTypes) {
    ...
    <>
      ...
      <Collapse in={open}>
        <div id="example-collapse-text" style={{paddingLeft: '6%'}}>
          <Link className={CollapseToggleStyle.itemCollapse} href="/">- Basicas</Link>
          <Link className={CollapseToggleStyle.itemCollapse} href="/">- Cientificas</Link>
        </div>
      </Collapse>
    </>
  );
