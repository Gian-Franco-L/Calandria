...
export default function Geometria({ option } : PageTypes) {
    ...
    <>
      ...
      <Collapse in={open}>
        <div id="example-collapse-text" style={{paddingLeft: '6%'}}>
          <Link className={CollapseToggleStyle.itemCollapse} href="/">- Reglas</Link>
          <Link className={CollapseToggleStyle.itemCollapse} href="/">- Compás</Link>
        </div>
      </Collapse>
    </>
  );
